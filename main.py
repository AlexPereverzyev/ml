...
if __name__ == "__main__":
    ...
    test_regression_skl('Logistic Regression 1 (SKL)', TrainingSet2,
    ...
    test_regression_skl('Logistic Regression 2 (SKL)', TrainingSet4,
    ...
    # test_regression_skl('Slowness Probability (SKL)', TrainingSet3,
    #                     ValidationSet3, 0, linear_model.LogisticRegression)
